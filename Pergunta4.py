...
class Tela_Pergunta(QWidget):
    ...
    def initUI(self):
        ...
        self.label_pergunta = QLabel("""4. Seus amigos te descrevem como ...
                                     """)
        #label_pergunta.setAlignment(Qt.AlignCenter)
        
        
        self.label_altA = QLabel("Persistente")
        self.label_altB = QLabel("Inteligente")
        self.label_altC = QLabel("Dedicado(a)")
        self.label_altD = QLabel("Determinado(a)")
